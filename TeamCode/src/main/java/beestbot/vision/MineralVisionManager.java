...
public class MineralVisionManager extends VisionManager {
    private MineralMasterVision vision;

    public MineralVisionManager(HardwareMap hardwareMap, MineralMasterVision.TFLiteAlgorithm infer, boolean useFlash) {
