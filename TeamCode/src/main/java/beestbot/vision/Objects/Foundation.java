package beestbot.vision.Objects;
...
public class Foundation {
    ...
    public void draw(Mat canvas) {
        ...
        Imgproc.putText(canvas, t.toString(), bounds.tl(), 0, 0.6, black, 7);
        Imgproc.putText(canvas, t.toString(), bounds.tl(), 0, 0.6, color, 2);
     ...
     */
    public static Foundation createFoundation(Detected d, Detected j) {
