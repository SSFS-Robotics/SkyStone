...
public class Detected {
    ...
    MatOfPoint shape;
    Color      c;
    public boolean    isBastard = false;
    public Rect       bounds;
    ...
    public void draw(Mat canvas) {
        ...
        Imgproc.putText(canvas, c.toString(), new Point(x, y - 30), 0, 0.6, black, 7);
        Imgproc.putText(canvas, c.toString(), new Point(x, y - 30), 0, 0.6, color, 2);
