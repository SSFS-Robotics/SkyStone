 ...
 */
@TeleOp(name = "DogeCV Skystone Webcam", group="DogeCV")
/* EXAMPLE CODE FOR RECOGNIZING SKYSTONE USING DOGECV STONE DETECTOR*/
public class SkystoneDetectorExampleWebcam extends LinearOpMode {
